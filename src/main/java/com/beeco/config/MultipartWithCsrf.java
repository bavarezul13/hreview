...
authorized users will be able to submit a File that is processed by your application. In general, this is the
recommended approach because the temporary file upload should have a negligble impact on most servers.*/
public class MultipartWithCsrf extends AbstractSecurityWebApplicationInitializer{
